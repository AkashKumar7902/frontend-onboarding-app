// This file defines the metadata for each dynamic entity in our system.
// Our generic components will use this config to render the correct UI.
...
export const entityConfig = {
  locations: {
    title: 'Locations', // For page headers
    listColumns: [ // Columns to show in the table
      { header: 'Name', accessor: 'name' },
      { header: 'Address', accessor: 'address' },
    ],
    fields: [ // Fields for the create/edit form
  ...
  departments: {
    ...
    fields: [
      ...
      { name: 'head', label: 'Department Head', type: 'text', required: false },
    ],
  },
  managers: {
        title: 'Managers',
        ...
        fields: [
        { name: 'name', label: 'Manager Name', type: 'text', required: true },
    ...
    fields: [
        { name: 'name', label: 'Job Role Name', type: 'text',
            required: true },
  ...
  employementTypes: {
    ...
    fields: [
      { name: 'name', label: 'Employment Type Name', type: 'text', required: true },
      { name: 'description', label: 'Description', type: 'text', required: false },
    ],
  },
  teams: {
    ...
    hardwareAssets: {
        ...
        { name: 'modelNumber', label: 'Model Number', type: 'text', required: false },
        ],
    },
    onboardingBuddy: {
        ...
        listColumns: [
        { header: 'Name', accessor: 'name' },
        { header: 'Team', accessor: 'teamId' }, // This will be a reference to the team
        ],
        fields: [
        { name: 'name', label: 'Buddy Name', type: 'text', required: true },
        { name: 'teamId', label: 'Team', type: 'select', options: [], required: false }, // Options will be populated dynamically
        ],
    },
    accessLevels: {
        title: 'Access Levels',
        ...
        fields: [
        { name: 'name', label: 'Access Level Name', type: 'text', required: true },
        { name: 'description', label: 'Description', type: 'text', required: false },
        ],
    },

  // ... You can now easily add configs for all other entities here!
  // For example:
  // 'job-roles': { ... },
  // 'costs': { ... },
};
